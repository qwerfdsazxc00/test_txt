...
public class DateUtils {
	...
	public static final String DATE_FORMAT_YMD_O = "yyyy/MM/dd";
	...
	/**
	 *  * 日期转换为制定格式字符串  *  * @param time  * @param format  * @return  
	 */
	 ...
	 *  * 否则异常抛出)  * @param date  * @param format  * @return  * @throws
	 * ParseException  * @  
	 */
	public static Date formatStringToDate(String date, String format) {
		...
		try {
			...
			log.error("formatStringToDate方法异常",ex);
			throw new RuntimeException(ex.toString());
		}
	}

	/**
	 *  * 判断一个日期是否属于两个时段内  * @param time  * @param timeRange  * @return  
	 */
	...
	/**
	 *  * 从完整的时间截取精确到分的时间  *  * @param fullDateStr  * @return  
	 */
	 ...
	 * 例如：2008-12-29是星期一，2009-01-04是星期日，哪么这个周就是2008年度的最后一个周。  *  * @param year  *  
	 * 格式 YYYY ，必须大于1900年度 小于9999年  * @return @  
	 */
	...
	/**
	 *  * 计算指定年、周的上一年、周  *  * @param year  * @param week  * @return @  
	 */
	...
	/**
	 *  * 下一个[周，年]  *  * @param year  * @param week  * @return @  
	 */
	...
	/**
	 *  * 计算指定年度共有多少个周。(从周一开始)  *  * @param year  * @return @  
	 */
	...
	public static int getWeekNumOfYear(final int year, int firstDayOfWeek) {
		...
		String yearTmp = date.substring(0, sIndex);
		if (yearTmp.equals(year + "")) {
			result = maxWeeks;
		}
		return result;
	}
	...
	/**
	 *  * 获取指定年份的第几周的第几天对应的日期yyyy-MM-dd(从周一开始)  *  * @param year  * @param
	 * weekOfYear  * @param dayOfWeek  * @return yyyy-MM-dd 格式的日期 @  
	 */
	...
	/**
	 *  * 获取指定年份的第几周的第几天对应的日期yyyy-MM-dd，指定周几算一周的第一天（firstDayOfWeek）  *  * @param
	 * year  * @param weekOfYear  * @param dayOfWeek  * @param firstDayOfWeek  *  
	 * 指定周几算一周的第一天  * @return yyyy-MM-dd 格式的日期  
	 */
	...
	/**
	 *  * 获取指定日期星期几  *  * @param datetime  * @throws ParseException  * @  
	 */
	...
	/**
	 *  * 计算某年某周内的所有日期(从周一开始 为每周的第一天)  *  * @param yearNum  * @param weekNum
	 *  * @return @  
	 */
	...
	/**
	 *  * 计算某年某周内的所有日期(七天)  *  * @param yearNum  * @param weekNum  * @return
	 * yyyy-MM-dd 格式的日期列表  
	 */
	...
	/**
	 *  * 获取目标日期的上周、或本周、或下周的年、周信息  *  * @param queryDate  *   传入的时间  * @param
	 * weekOffset  *   -1:上周 0:本周 1:下周  * @param firstDayOfWeek  *   每周以第几天为首日
	...
	/**
	 *  * 计算个两日期的天数  *  * @param startDate  *   开始日期字串  * @param endDate  *   结束日期字串
	 *  * @return  * @throws ParseException  
	 */
	...
	/**
	 *  * 计算两个日期之间的天数差  * @param startDate  * @param endDate  * @return  
	 */
	...
	/**
	 *  * 计算两个日期之间的年份差距  *  * @param firstDate  * @param secondDate  * @return  
	 */
	...
	/**
	 *  * 计算两个日期之间的月份差距  *  * @param firstDate  * @param secondDate  * @return  
	 */
	...
	/**
	 *  * 从date开始计算time天后的日期  *  * @param date  * @param time  * @return  * @throws
	 * ParseException  
	 */
	...
	/**
	 *  * 获取从某日期开始计算，指定的日期所在该年的第几周  *  * @param date  * @param admitDate  * @return
	...
	/**
	 *  * 获取指定日期refDate，前或后一周的所有日期  *  * @param refDate  *   参考日期  * @param
	 * weekOffset  *   -1:上周 0:本周 1:下周  * @param startDate  *   哪天算一周的第一天  * @return
	 * yyyy-MM-dd 格式的日期  * @throws ParseException  * @  
	 */
	...
	/**
	 *  * 根据时间点获取时间区间  *  * @param hours  * @return  
	 */
	...
	/**
	 *  *  * 根据指定的日期，增加或者减少天数  *  * @param date  * @param amount  * @return  
	 */
	...
	/**
	 *  * 根据指定的日期，类型，增加或减少数量  *  * @param date  * @param calendarField  * @param
	 * amount  * @return  
	 */
	...
	/**
	 *  * 获取当前日期的最大日期 时间2014-12-21 23:59:59  * @return  
	 */
	...
	/**
	 *  * 获取当前日期的最小日期时间 2014-12-21 00:00:00  * @return  
	 */
	...
	private static final String FILE_SPLIT_DAY = "yyyy/MM/dd";

	/**
	 * 返回当前日期的 yyyy/MM/dd 格式
	 * 
	 * @return
	 * @author Jerry.chen
	 * @date 2019年2月27日
	...
	public static String getCurrentDay() {
		...
		String currentDay = formatDateToString(currentDate, FILE_SPLIT_DAY);
		return currentDay;
	}
